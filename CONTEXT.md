...
3. **Level-by-level table** — 8 columns: Level, HP, MP, Base INT, **Non-INT Pool**, Phase, AP Resets this level, Cumulative AP Resets. The pool sits beside **Base INT** so the swap is visible: at **Swap Level** **Base INT** collapses to its starting value and the pool jumps by the same amount, because the flushed INT lands in **Main Stat** and is movable again. The pool is shown rather than **Main Stat** because it answers the question the plan actually turns on — how much AP is still movable — and it stays honest after a pre-game **Shift to INT**, which the **Main Stat** column cannot show (the shift may have come from any non-INT stat). Collapsed by default. The Phase column shows one of: *Build Base INT* / *Build &lt;Main Stat&gt;* / *MP Wash* / *MP Wash + Reset INT* / *MP Wash + Pre-Swap Fresh HP Wash* / *MP Wash + Fresh HP Wash + Reset INT* / *MP + Fresh + Stale HP Wash + Reset INT* / *Pre-Swap Fresh HP Wash* / *Fresh HP Wash* / *Fresh HP Wash + Reset INT* / *Stale HP Wash* / *Stale HP Wash + Reset INT* / *Fresh + Stale HP Wash* / *Fresh + Stale HP Wash + Reset INT* / *MP-Cap HP Wash* (Mage endgame) / *Reset Base INT* / *Done*. A level that also spends AP on the **First Job Requirement** is prefixed with *&lt;STAT&gt; for 1st Job + …*.
